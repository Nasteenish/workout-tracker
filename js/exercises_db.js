...
const EXERCISE_DB = [
    ...
    { nameRu: 'Разводка в тренажёре (Pec Deck)', name: 'Pec Deck Machine',          category: 'chest' },
    ...
    { nameRu: 'Отжимания на брусьях (грудь)',  name: 'Dips (Chest)',                category: 'chest' },
    ...
    { nameRu: 'Тяга Хаммер',                   name: 'Hammer Row',                  category: 'back' },
    { nameRu: 'Пуловер на блоке',              name: 'Cable Pullover',              category: 'back' },
    ...
    { nameRu: 'Мёртвая тяга',                  name: 'Stiff Legged Deadlift',       category: 'legs' },
    ...
    { nameRu: 'Ягодичный мост с гантелей',      name: 'Dumbbell Hip Thrust',         category: 'glutes' },
    ...
    { nameRu: 'Подъём на платформу',            name: 'Step-up',                     category: 'glutes' },
    ...
    { nameRu: 'Жим Арнольда',                  name: 'Arnold Press',                category: 'shoulders' },
    ...
    { nameRu: 'Махи в кроссовере',             name: 'Cable Lateral Raises',        category: 'shoulders' },
    ...
    { nameRu: 'Сгибания на бицепс на блоке',    name: 'Cable Curl',                  category: 'arms' },
    ...
    { nameRu: 'Разгибание рук в тренажёре',     name: 'Tricep Extension Machine',    category: 'arms' },
    ...
    { nameRu: 'Подъём ног в упоре',             name: 'Captain Chair Leg Raise',     category: 'core' },

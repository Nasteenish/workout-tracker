...
export const EXERCISE_DB = [
    ...
    { nameRu: 'Вертикальная тяга (обратным хватом на блоке)', name: 'Reverse Grip Lat Pulldown (Cable)', category: 'lats' },
    { nameRu: 'Вертикальная тяга (с резинкой)', name: 'Lat Pulldown (Band)', category: 'lats' },
    { nameRu: 'Вертикальная тяга (узким хватом на блоке)', name: 'Lat Pulldown - Close Grip (Cable)', category: 'lats' },
    { nameRu: 'Подтягивание (в гравитроне обратным хватом)', name: 'Chin Up (Assisted)', category: 'lats' },
    { nameRu: 'Подтягивание (в гравитроне)', name: 'Pull Up (Assisted)', category: 'lats' },
    { nameRu: 'Подтягивание (во своим весом обратным хватом)', name: 'Chin Up', category: 'lats' },
    { nameRu: 'Подтягивание (с отягощением обратным хватом)', name: 'Chin Up (Weighted)', category: 'lats' },
    { nameRu: 'Подтягивание (с отягощением)', name: 'Pull Up (Weighted)', category: 'lats' },
    { nameRu: 'Подтягивание (с резинкой)', name: 'Pull Up (Band)', category: 'lats' },
    { nameRu: 'Подтягивание (со своим весом)', name: 'Pull Up', category: 'lats' },
    { nameRu: 'Пуловер (в тренажёре)', name: 'Pullover (Machine)', category: 'lats' },
    { nameRu: 'Пуловер (на блоке с канатом)', name: 'Rope Straight Arm Pulldown', category: 'lats' },
    { nameRu: 'Пуловер (на блоке с прямой ручкой)', name: 'Straight Arm Lat Pulldown (Cable)', category: 'lats' },

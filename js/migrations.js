...
var _NAME_MAP = {
    ...
    'Верхняя тяга раздельная (в тренажёре)': ['Iso-Lateral High Row (Machine)', 'Тяга верхнего блока (Iso-Lateral)'],
    'Нижняя тяга раздельная': ['Iso-Lateral Low Row', 'Тяга нижнего блока сидя (Iso-Lateral)'],
    'Тяга раздельная (в тренажёре)': ['Iso-Lateral Row (Machine)', 'Тяга сидя (Iso-Lateral)'],
    'Жим от груди раздельный (в тренажёре)': ['Iso-Lateral Chest Press (Machine)', 'Жим от груди (Iso-Lateral)'],

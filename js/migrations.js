...
var _NAME_MAP = {
    ...
    'Кикбек (в тренажёре)': ['Glute Kickback (Machine)', 'Отведение ноги назад (в тренажёре)'],
    ...
    'Glute cable kickbacks': ['Standing Cable Glute Kickbacks', 'Отведение ноги назад (на блоке)'],
    'High cable glute kickbacks': ['Standing Cable Glute Kickbacks', 'Отведение ноги назад (на блоке)'],
    'Кикбек стоя (на блоке)': ['Standing Cable Glute Kickbacks', 'Отведение ноги назад (на блоке)'],
    'Отведение ноги назад стоя (на блоке)': ['Standing Cable Glute Kickbacks', 'Отведение ноги назад (на блоке)'],
    'Отведение ноги назад (блок) стоя': ['Standing Cable Glute Kickbacks', 'Отведение ноги назад (на блоке)'],
...
export const Migrations = {
    ...
    cleanOrphanedLogEntries() {
        try {
            ...
            // Legacy snapshot system removed — templates now stored in log._template
        } catch (e) {

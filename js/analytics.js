...
const PR_TOASTS = [
    ...
    'Ты — машина!',
    'Да ты монстр!',
    'Фил Хит завидует твоей генетике',
    'YEAH BUDDY!',
    'Этот подход войдёт в историю',
    'Это не подход, это произведение искусства',
    'Тебя нужно показывать в музее силы',
    'Кто тут монстр? Ты тут монстр.',
];

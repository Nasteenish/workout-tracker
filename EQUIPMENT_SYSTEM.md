...
| Cybex | 131 | 110 | 21 | `tools/insert_cybex.sql` (131 data rows, 21 PWR PLAY без картинок) | `cybex/` (180 файлов*) |
...
| **Итого** | **421** | **400** | **21** | **4 SQL-файла** | **470 файлов** |
...
**Остаток:**
- [ ] Выполнить SQL в Supabase DB
- [ ] Загрузить картинки в `equipment-images/cybex/` (21 файл)
- [ ] Обновить image_url в БД и SQL-файле

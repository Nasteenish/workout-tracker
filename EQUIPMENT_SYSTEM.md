...
| Cybex | 131 | 119 | 12 | `tools/insert_cybex.sql` (131 data rows, 12 PWR PLAY без картинок) | `cybex/` (189 файлов) |
...
| **Итого** | **421** | **409** | **12** | **4 SQL-файла** | **479 файлов** |
...
**Статус:** `[~]` (2026-03-20)
**Приоритет:** HIGH
**Описание:** 21 станция PWR PLAY отсутствовала в каталоге. Добавлены в `insert_cybex.sql` (IDs 408-428).

**Добавленные станции (21):**

| ID | Model | Name | exercise_type |
|----|-------|------|---------------|
| 408 | PP-AP | PWR Play Adjustable Pulley 2:1 | cable_multi |
| 409 | PP-LP | PWR Play Lat Pull | lat_pulldown |
| 410 | PP-RW | PWR Play Low Row | seated_row |
| 411 | PP-TP | PWR Play Triceps Pushdown | tricep_extension |
| 412 | PP-ACO | PWR Play Attached Cable Crossover | chest_fly,cable_multi |
| 413 | PP-AXO | PWR Play Embedded Cable Crossover | chest_fly,cable_multi |
...
| 419 | PP-ADC | PWR Play Dip Chin Assist | chest_dip,tricep_dip |
| 420 | PP-LPD | PWR Play Dual Pulley Pulldown | lat_pulldown |
| 421 | PP-RWD | PWR Play Dual Pulley Row | seated_row |
| 422 | PP-DPH | PWR Play Dual Pulley High | cable_multi |
| 423 | PP-DPL | PWR Play Dual Pulley Low | cable_multi |
| 424 | PP-BX | PWR Play Boxing Station | NULL |
| 425 | PP-SB | PWR Play Stall Bars | NULL |
| 426 | PP-RPL | PWR Play Rope Pull | cable_multi |
| 427 | PP-RP | PWR Play Rope Pull Power Pivot | cable_multi,torso_rotation |
| 428 | PP-DIP | PWR Play Dip Station | chest_dip,tricep_dip |

**Выполнено:**
- [x] SQL выполнен в Supabase DB (21 запись)
- [x] 9 картинок скачаны с lifefitness.com и загружены в `equipment-images/cybex/`
- [x] image_url обновлены в БД и SQL-файле для 9 станций

**Остаток — 12 станций без картинок (нет на lifefitness.com):**
PP-AP, PP-LP, PP-RW, PP-TP, PP-AXO, PP-ADC, PP-RWD, PP-BX, PP-SB, PP-RPL, PP-RP, PP-DIP

**Источники картинок:** lifefitness.com/en-us/catalog/cybex/cybex-products/ и lifefitness.com PWR Play page

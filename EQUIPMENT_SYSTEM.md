...
**Статус:** `[x]` (2026-03-21, обновлено)
**Приоритет:** HIGH
**Описание:** Добавлены 16 станций PWR PLAY с фото в каталог. 12 станций без фото удалены ранее, 7 из них восстановлены с фото (2026-03-21).

**Добавленные станции (16, все с картинками):**
...
| 424 | PP-ECO | PWR Play Embedded Cable Crossover | chest_fly,cable_multi |
| 425 | PP-AC | PWR Play Adjustable Cable Column | cable_multi |
| 426 | PP-DHLP | PWR Play Dual Handle Lat Pull | lat_pulldown |
| 427 | PP-LR | PWR Play Low Row | seated_row |
| 428 | PP-ADHLR | PWR Play Adjustable Dual Handle Low Row | seated_row |
| 429 | PP-TP | PWR Play Triceps Pushdown | tricep_extension |
| 430 | PP-DCA | PWR Play Dip/Chin Assist | chest_dip,tricep_dip,lat_pulldown |

**Источники картинок:** locator.lifefitness.com/products/pwrplay/
